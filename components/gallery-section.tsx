    ...
    <section id='gallery' ref={sectionRef} className='py-16'>
      <div ref={headerRef}>
        <SectionHeader
          title='Նկարներ'
          accentWord='Նկարներ'
          subtitle='Այգետնակ №206-ում օրը տոն է դառնում, երբ այն լի է գեղեցիկ և հիշարժան պահերով։ Ծանոթացեք նկարներին և մի վարանեք կայացնելու որոշում ՝ հրաշալի ու արկածային օր ունենալու համար'
        />
      </div>
                ...
                >
                  ...
                  <div className='p-6'>
                    <div className='relative aspect-[4/3] overflow-hidden rounded-xl'>
                      ...
                      <div className="absolute inset-0 bg-[url('/placeholder.svg?height=100&width=100')] opacity-0 group-hover:opacity-5 transition-opacity duration-200"></div>
